										...
										<div class="space-6"></div>
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													<div class="profile-info-name"> Nro </div>
													<div class="profile-info-value">
														<input type="text" id="textEditar" placeholder="Escribir aquí" name="Nro" class="form-control" required="required" value="{!! $usuario->dni or $dni!!}">
													</div>
												</div>
												<div class="profile-info-row">
													<div class="profile-info-name"> Capa </div>
													<div class="profile-info-value">
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> Costo Unitario</div>
													<div class="profile-info-value">
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> Nro de Factura</div>
													<div class="profile-info-value">
